...
{
    public class ReservationControllerTest : IControllerTest
    {
        [Fact]
        ...
        [Fact]
        public void PostShouldReturnErrorCode400WhenStartDateIsAfterEndDate()
        {
            throw new NotImplementedException();
        }

        [Fact]
        public void PostShouldReturnErrorCode400WhenStartDateIsEqualEndDate()
        {
            throw new NotImplementedException();
        }
        ...
        [Fact]
        public void PuttShouldReturnErrorCode400WhenStartDateIsAfterEndDate()
        {
            throw new NotImplementedException();
        }

        [Fact]
        public void PutShouldReturnErrorCode400WhenStartDateIsEqualEndDate()
        {
            throw new NotImplementedException();
        }
