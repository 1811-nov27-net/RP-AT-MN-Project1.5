...
{
    public class EventCustomerController : AServiceController
    {
        public EventCustomerController(HttpClient client) : base(client) { }
        ...
        public async Task<ActionResult> Index()
        {
            ...
            List<EventCustomer> Customers = JsonConvert.DeserializeObject<List<EventCustomer>>(responseBody);
        ...
        // send "GET api/Customer" to service, get headers of response
        {
            ...
            // we could use DataContractSerializer, .NET built-in, but it's more awkward
            // than the third-party Json.NET aka Newtonsoft JSON.
            EventCustomer Customer = JsonConvert.DeserializeObject<EventCustomer>(responseBody);
